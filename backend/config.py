...
FORECAST_OUTPUT_ROOT = MODEL_OUTPUT_ROOT / "forecast"
FORECAST_ASSUMPTIONS_PATH = PROJECT_ROOT / "backend" / "forecast_assumptions.json"
FORECAST_METADATA = FORECAST_OUTPUT_ROOT / "forecast_metadata.json"
ROUTING_ASSUMPTIONS_PATH = PROJECT_ROOT / "backend" / "routing_assumptions.json"
